...
<template>
  <section class="flex h-full flex-col" data-testid="trigger-details">
    <div class="flex-1 space-y-4 overflow-y-auto px-4 py-4">
      <div
        class="flex items-center gap-2 rounded-md border border-sky-200 bg-sky-50 px-3 py-2 text-xs text-sky-800 dark:border-sky-500/40 dark:bg-sky-950/40 dark:text-sky-200"
      >
        <Lock class="size-3.5" />
