  ...
  <form class="flex h-full flex-col" novalidate @submit="onSubmit">
    <div class="flex-1 space-y-4 overflow-y-auto px-4 py-4">
      ...
      <div class="space-y-2">
        ...
        <div
          class="grid grid-cols-[3.5rem_6.5rem_1fr_0.5rem_1fr] items-center gap-x-3 px-3 pb-1 text-[10px] font-medium uppercase tracking-wide text-muted-foreground"
          aria-hidden="true"
        >
          <span>Day</span>
          <span>Status</span>
        ...
        <div class="space-y-1.5">
          <div
            ...
            :key="field.key"
            :class="[
              'grid grid-cols-[3.5rem_6.5rem_1fr_0.5rem_1fr] items-center gap-x-3 rounded-md border px-3 py-2 transition-colors',
