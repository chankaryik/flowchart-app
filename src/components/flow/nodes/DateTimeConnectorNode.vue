...
<template>
  <div
    ...
    :class="
      isSuccess
        ? 'border-emerald-400 bg-emerald-100 text-emerald-800 dark:border-emerald-500/50 dark:bg-emerald-950/50 dark:text-emerald-200'
        : 'border-rose-400 bg-rose-100 text-rose-800 dark:border-rose-500/50 dark:bg-rose-950/50 dark:text-rose-200'
    "
